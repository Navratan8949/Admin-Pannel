...
import Teamtable from "../Components/Application/Chat/ChatApp/Teamtable";
import Userreferral from "../Components/Application/Chat/ChatApp/Userreferral";
import UserDetails from "../Components/Application/Chat/ChatApp/UserDetails";
...
export const routes = [
  ...
  { path: `/widgets/AllDeposite/:layout`, Component: <General /> },
  ...
  { path: `/forms/widget/datetimepicker/:layout`, Component: <DateTimeContain /> },
  { path: `/forms/widget/rangepicker/:layout`, Component: <FormDateRangepickerContain /> },
  ...
  { path: `/Deposite/AllDeposite`, Component: <AllDeposite /> },
  ...
  { path: `/Teamtable/:layout`, Component: <Teamtable /> },
  { path: `/Userreferral/:layout`, Component: <Userreferral /> },
  { path: `/user/:userId/layout`, Component: <UserDetails /> },
  ...
  { path: `/app/ecommerce/FundTransfer/:layout`, Component: <Products /> },
  { path: `/app/ecommerce/TransferHistory/:layout`, Component: <ProductPage /> },
